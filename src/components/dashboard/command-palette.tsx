...
function PaletteInner({ onOpenChange }: { onOpenChange: (open: boolean) => void }) {
  ...
  const actions = useMemo<CommandAction[]>(
    () => [
      ...
      { id: "nav-typing", label: "Test Typing Speed", subtitle: "Speed & accuracy game", icon: Keyboard, group: "Navigate", keywords: "game typing speed wpm accuracy keyboard", run: () => navigate("typing") },
